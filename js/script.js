...
const pens = {
  ...
  19:{name:"Beyond Time", desc:"Crafted from solid aluminium, the BEYOND TIME pen is designed for those who appreciate engineering, minimalism, and enduring quality. Every detail has a purpose—from its precision-machined body to its balanced weight—creating a writing instrument that feels as refined as it looks. Unlike disposable plastic pens, aluminium offers exceptional durability while remaining lightweight and comfortable for everyday use. Its satin-machined finish highlights the natural beauty of the metal, developing character through years of use rather than wearing out. Aluminium is also corrosion-resistant and highly recyclable, making it a practical long-term material choice. The engraved BEYOND TIME name reflects more than a design—it represents ideas that outlast trends, craftsmanship that endures, and writing that leaves a lasting impression.", features:["Material: Anodized Aluminium ","Grip: 5 lines for Comfort","Endcaps: Knurled screw end supported by spring","Limited Edition","Weight: 20g","Length: 127 mm","Grip diameter: 8 mm","Cartridge type: 3mm with spring notch","Engravings:Bold text: BEYOND TIME, on the cone: GRIP TECHNOLOGY"],  images:["images/beyond_time_0b.jpg","images/beyond_time_2a.jpg","images/beyond_time_3.jpg","images/beyond_time_4.jpg"],video:"video/beyond_time.mp4"},
